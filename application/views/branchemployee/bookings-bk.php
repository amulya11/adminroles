			...
			<!-- general-form elements starts-->
				...
				<div class="box-header with-border">
					...
					<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 cour-date-wdnon">
								<label>Start</label>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <table class="table table-bordered table-striped bs-events-table" id="bookings_table">
                                    <thead>
                                        <tr>
											<th class="text-center" style="width:13%">Course</th>
				...
				success:function(data){
					...
					$.each(data.bookings, function(i){
							...
							if(item.courseStatus=="1")
								course_type_name+="<strong>Course Status:</strong><p><a class='btn btn-success input-sm'>Active</a></p>";
							else if(item.courseStatus=="0")
								course_type_name+="<strong>Course Status:</strong><p><a class='btn btn-warning input-sm'>Inactive</a></p>";
							else
								course_type_name+="<strong>Course Status:</strong><p><a class='btn btn-danger input-sm'>Deleted</a></p>";
							...
							html+="<tr><td>"+course_type_name+"</td><td>"+student_details+"</td>"+
								"<td>"+reg_dtls+"</td><td>"+schemes_string+"</td><td>"+payment_dtls+"</td></tr>";
